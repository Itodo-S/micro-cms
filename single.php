	    		...
	    		<div class="row d-flex">
	    			<div class="col-lg-8 px-md-5 py-5">
	    				<div class="row pt-md-4">
                            <?php
                                ...
                                $title = $counter = $image = $cartegory = $body = $author = $date = "";
								// $title = $_GET['id'];
								if(isset($_GET['read'])){
									$id = $_GET['read'];
						  ...
						  while($auth_row = mysqli_fetch_assoc($auth_result)){
							  $author = $auth_row['username'];
								...
								<h4 ><strong style="font-family:arial;"> <i class ="icon icon-user">'.$author.'</i></strong></h4>';
		            ...
		            <div class="pt-5 mt-5">
							...
							$counter = mysqli_num_rows($results);
								...
								echo '<h3 class="mb-5 font-weight-bold">'.$counter.' Comments</h3>';
							?>
		              <!-- END comment-list -->
		              <?php
							// $id = $_GET['read'];
								...
								$comment = sanitize_data($_POST['txtComment']);
								$name = sanitize_data($_POST['txtName']);
								$postId = sanitize_data($_POST['postId']);

								$sql = "INSERT INTO comments (post_id,comment,name) VALUES('$postId','$comment','$name')";
								$result = mysqli_query($conn,$sql);
						...
						if(isset($_POST['btnReply'])){
							$reply = sanitize_data($_POST['txtReply']);
								...
								<div class="comment-body">
								  ...
								  <p>'.$comment.'</p>
									<div class="dropdown">
										...
										<div class="dropdown-menu" style = "border:none" aria-labelledby="triggerId">
											<form action="single.php" method = "post">
												<div class="form-group">
													<label for=""></label>
													<textarea name="txtReply" id="" cols="10" rows="" placeholder = "Reply..."></textarea>
													<button type="submit" style="border:none" class = "icon-paper-plane btn-light" name="btnReply"><i ></i></button>
												</div>
											</form>
										</div>
									</div>
		              ...
		              <div class="comment-form-wrap pt-5">
		                ...
		                <form action="single.php" method="post" class="p-3 p-md-5 bg-light">
		                  <div class="form-group">
		                  ...
		                  <div class="form-group">
		                    ...
		                    <textarea name="txtComment" id="message" cols="30" rows="10" class="form-control" required></textarea>
		                  </div>
		                  <div class="form-group">
		                    <input type="submit" name="btnSubmit" value="Post Comment" class="btn py-3 px-4 btn-primary">
							<input type="text" value = "<?php echo $id; ?>" name = "postId" style = "visibility:hidden">
		                  </div>
