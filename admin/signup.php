              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form action="signup.php" method="POST" class="pt-3">
                  <div class="form-group">
                    <input type="text" name="txtFirstname" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="First name" required>

                    <input type="text" name="txtLastname" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Last name" required>
