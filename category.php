		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="tracategoryvel.php">Travel</a></li>
		...
		<div id="colorlib-main">
	    	...
	    	<div class="container">
	    			...
	    			<div class="col-xl-8 px-md-5 py-5">
	    				<div class="row pt-md-4">
	    					<div class="col-md-12">
	    						...
	    						echo '	<a href="#"><img class="img" src="admin/'.$image.'"></a>
                                <div class="text pt-4">
                          <h3 class="mb-4"><a href="#">'.$title.'</a></h3>
                          <p class="mb-4">'.$body.'</p>
                          <div class="author mb-4 d-flex align-items-center">
                                <a href="#"><img class="img" src="admin/'.$image.'"></a>
                                <div class="ml-3 info">
                                    <span>Written by</span>
                                    <h3><a href="#">'.$author.'</a>, <span>'.$date.'</span></h3>
                                </div>
                            </div>
                          <div class="meta-wrap d-md-flex align-items-center">
                              ...
                              <div class="half">
                                  <p><a href="single.php?read='.$row['id'].'" class="btn btn-primary p-3 px-xl-4 py-xl-3">Continue Reading</a></p>
                              </div>
                          </div>
                        </div>';
									}
				...
				<div class="sidebar-box ftco-animate">
	              ...
	              <div class="block-21 mb-4 d-flex">
				  <a class="blog-img mr-4" style="background-image: url(admin/uploads/5f849ecdcbe57.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> <?php echo $date; ?></a></div>
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(admin/uploads/5f7376357257f.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> <?php echo $date; ?></a></div>
